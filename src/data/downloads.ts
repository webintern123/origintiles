...
export const downloads: Download[] = [
  ...
  {
    id: "catalog-1",
    title: "Origin Tiles – Complete Product Catalogue 2025",
    description: "Comprehensive catalogue covering all six collections with images, specifications, and design references.",
  ...
  },
  {
    ...
    description: "Detailed brochure highlighting premium designs, layouts, and usage suggestions.",
    category: "Brochure",
    format: "PDF",
    fileSize: "12 MB",
    pages: 24,
  ...
  },
  {
    ...
    description: "Design-focused lookbook showcasing contemporary tile concepts for modern spaces.",
    category: "Brochure",
    format: "PDF",
    fileSize: "18 MB",
    pages: 32,
  ...
  // ===== TECHNICAL SPECIFICATIONS =====
  {
    ...
    description: "Detailed technical data including dimensions, absorption values, slip resistance, and compliance standards.",
  ...
  },
  {
    ...
    description: "Collection-specific technical information covering material composition and performance details.",
    category: "Technical Specifications",
    format: "PDF",
    fileSize: "4 MB",
    pages: 16,
  ...
  // ===== INSTALLATION GUIDES =====
  {
    ...
    description: "Step-by-step guidance on surface preparation, adhesives, grouting, and best practices.",
    ...
    downloads: 9876,
    featured: true,
    collections: ["Professional guide"],
  ...
  },
  {
    ...
    description: "Specialised guide for handling and installing large-format tiles with precision.",
    category: "Installation Guide",
    format: "PDF",
    fileSize: "6 MB",
    pages: 20,
  ...
  },
  {
    ...
    description: "Installation guidance for bathrooms and wet zones, including waterproofing considerations.",
    category: "Installation Guide",
    format: "PDF",
    fileSize: "9 MB",
    pages: 28,
    ...
    downloads: 6234,
    featured: false,
    collections: ["Installation guide"],
  ...
  // ===== MAINTENANCE GUIDES =====
  {
    ...
    description: "Cleaning and care instructions to maintain tile finish and long-term performance.",
  ...
  },
  {
    ...
    description: "Specific maintenance and sealing guidelines for natural stone tiles.",
    category: "Maintenance Guide",
    format: "PDF",
    fileSize: "3 MB",
    pages: 12,
  ...
  // ===== CAD/BIM FILES =====
  {
    ...
    description: "AutoCAD drawings with accurate dimensions and technical details.",
  ...
  },
  {
    ...
    description: "Revit-compatible BIM files for professional architectural and design use.",
    category: "CAD/BIM Files",
    format: "RVT",
    fileSize: "280 MB",
    version: "2025.1",
  ...
  },
  {
    ...
    description: "High-quality 3D models with realistic textures for visualisation and rendering.",
    category: "CAD/BIM Files",
    format: "SKP",
    fileSize: "195 MB",
    version: "2025.1",
  ...
  // ===== CERTIFICATES =====
  {
    ...
    description: "Official certification confirming quality management standards.",
  ...
  },
  {
    ...
    description: "Includes sustainability and environmental compliance certifications.",
    category: "Certificate",
    format: "PDF",
    fileSize: "4.5 MB",
    pages: 12,
  ...
  // ===== WARRANTY DOCUMENTS =====
  {
    ...
    description: "Complete warranty coverage details for Origin Tiles products.",
    category: "Warranty Document",
    format: "PDF",
    fileSize: "2.8 MB",
    pages: 8,
    version: "2025.1",
    lastUpdated: "Oct 2025s",
    downloads: 5432,
    featured: false,
    thumbnailUrl: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=600&q=80",
    fileUrl: "#",
  ...
  },
  {
    ...
    description: "Form and instructions for extending product warranty coverage.",
    category: "Warranty Document",
    format: "PDF",
    fileSize: "850 KB",
    pages: 3,

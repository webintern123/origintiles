...
export const collections: Collection[] = [
  {
    ...
    brand: "Origin Tiles",
    description: "Elegant designs with premium finishes for high-end interiors.",
    bestFor: "Luxury Homes & Villas",
  ...
  },
  {
    ...
    brand: "Origin Tiles",
    description: "Stylish, slip-safe tiles designed for everyday comfort.",
    bestFor: "Bathrooms & Wet Areas",
  ...
  },
  {
    ...
    brand: "Origin Tiles",
    description: "Strong, easy-to-maintain tiles built for daily use.",
  ...
  },
  {
    ...
    brand: "Origin Tiles",
    description: "Marble-inspired designs with long-lasting performance.",
    bestFor: "Living Rooms & Feature Spaces",
  ...
  },
  {
    ...
    brand: "Origin Tiles",
    description: "Natural wood aesthetics with ceramic durability.",
    bestFor: "Bedrooms & Warm Interiors",
  ...
  },
  {
    ...
    brand: "Origin Tiles",
    description: "Unique patterns that add character to any space.",
    bestFor: "Accent Walls & Elevations",
